...
namespace age {
	...
	const int AGE_COLLIDES_CONTROLER_OBJECT_OVERLAPPING_ERROR = 15;
	...
	#ifndef AGE_SOUND_SOUNDMULTIPLE_SOUND_BUFFER_COUNT
	const uint8_t AGE_SOUND_SOUNDMULTIPLE_SOUND_BUFFER_COUNT = 3;
	#endif
}
